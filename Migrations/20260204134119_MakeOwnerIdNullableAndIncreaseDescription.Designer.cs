...
namespace visita_booking_api.Migrations
{
    ...
    [Migration("20260204134119_MakeOwnerIdNullableAndIncreaseDescription")]
    partial class MakeOwnerIdNullableAndIncreaseDescription
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VisitaBookingApi.Models.FeaturedEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("visita_booking_api.Models.Entities.AccommodationComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("visita_booking_api.Models.Entities.Amenity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Icon = "ac-unit",
                            IsActive = true,
                            LastModified = new DateTime(2026, 2, 4, 13, 41, 18, 883, DateTimeKind.Utc).AddTicks(9070),
                        ...
                        new
                        {
                            ...
                            Icon = "whatshot",
                            IsActive = true,
                            LastModified = new DateTime(2026, 2, 4, 13, 41, 18, 883, DateTimeKind.Utc).AddTicks(9690),
                            Name = "Heating"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            Icon = "location-city",
                            IsActive = true,
                            LastModified = new DateTime(2026, 2, 4, 13, 41, 18, 883, DateTimeKind.Utc).AddTicks(9700),
                            Name = "City View"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            Icon = "dry",
                            IsActive = true,
                            LastModified = new DateTime(2026, 2, 4, 13, 41, 18, 883, DateTimeKind.Utc).AddTicks(9710),
                            Name = "Hair Dryer"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            LastModified = new DateTime(2026, 2, 4, 13, 41, 18, 883, DateTimeKind.Utc).AddTicks(9720),
                            Name = "First Aid Kit"
                        });
                });
            ...
            modelBuilder.Entity("visita_booking_api.Models.Entities.BulletinEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("visita_booking_api.Models.Entities.Park", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("visita_booking_api.Models.Entities.ParkImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ParkId", "DisplayOrder");

                    b.ToTable("park_images", (string)null);
                });

            modelBuilder.Entity("visita_booking_api.Models.Entities.RefundPolicy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AccommodationId", "IsActive");

                    b.ToTable("RefundPolicies");
                });

            modelBuilder.Entity("visita_booking_api.Models.Entities.RefundPolicyTier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("RefundPolicyId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("RefundPolicyId", "DisplayOrder");

                    b.ToTable("RefundPolicyTiers");
                });

            modelBuilder.Entity("visita_booking_api.Models.Entities.RefundRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("visita_booking_api.Models.Entities.BulletinEvent", b =>
                {
                    b.HasOne("VisitaBookingApi.Models.User", "Creator")
                        .WithMany()
            ...
            modelBuilder.Entity("visita_booking_api.Models.Entities.ParkImage", b =>
                {
                    b.HasOne("visita_booking_api.Models.Entities.Park", "Park")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("visita_booking_api.Models.Entities.RefundPolicyTier", b =>
                {
                    b.HasOne("visita_booking_api.Models.Entities.RefundPolicy", "RefundPolicy")
                        .WithMany("Tiers")
            ...
            modelBuilder.Entity("visita_booking_api.Models.Entities.RefundRequest", b =>
                {
                    ...
                    b.HasOne("VisitaBookingApi.Models.User", "ProcessedByAdmin")
                        .WithMany()
                        .HasForeignKey("ProcessedByAdminId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("VisitaBookingApi.Models.User", "RequestedBy")
                        .WithMany()
